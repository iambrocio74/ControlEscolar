...
namespace MVCAppSGE.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public MateriasController(MVCAppSGEContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,idProfesor,Nombre,Clave")] Materia materia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,idProfesor,Nombre,Clave")] Materia materia)
        {
            if (id != materia.Id)
            {
                return NotFound();
